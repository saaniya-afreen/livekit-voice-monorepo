...
const defaultConfig: AppConfig = {
  title: "Kai Voice AI Agent",
  description: "Voice AI agents of Keppel",
  video_fit: "contain",
  settings: {
    editable: false,  // Disable settings editing
    theme_color: "cyan",
    chat: true,
    inputs: {
      camera: false,   // Remove camera
      screen: false,   // Remove screen share
      mic: true,       // Keep microphone
    },
    outputs: {
      audio: true,     // Keep audio
      video: false,    // Remove video
    },
  },
  show_qr: false,
};
