...
export default async function handleToken(
  ...
  // (LiveKit TokenSourceFetchOptions uses camelCase).
  if (options.participantAttributes && !options.participant_attributes) {
    options.participant_attributes = options.participantAttributes;
  }
